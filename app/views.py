...
def home(request):
    ...
    Fields	Description
    #ver 01
    #mode 22 = Online Dynamic QR Code 23 = Online Dynamic Secure QR Code 24 = Online Dynamic Secure QR Code Mandate
    ...
    #qrMedium 1 - PICK FROM GALLERY 02 - APP 03 -POS 04 -PHYSICAL/ Share Intent mode 05-ATM 06 -WEB
